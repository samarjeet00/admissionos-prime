...
if "%~1"=="" (
  ...
  echo.
  echo   users.bat add samar --name "Samar" --tier executive --telegram 123456789
  echo   users.bat add ravi --name "Ravi K" --tier operational --whatsapp 919876543210
  echo   users.bat set samar --whatsapp 919876543210
  echo   users.bat list
  echo   users.bat disable samar
  echo   users.bat enable samar
  echo   users.bat remove samar
  echo.
